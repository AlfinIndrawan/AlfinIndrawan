...
<!--END_SECTION:waka-->
Note: Xcode Code Signin apple id somehow broke when installing wakatime plugin (So there is no xcode time or swift time now). Maybe when i can, i will fix it.
